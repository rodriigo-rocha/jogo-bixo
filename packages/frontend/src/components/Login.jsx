...
function Login({onClose}){
    ...
    return(
        <div className="absolute top-[50%] left-[50%] bg-gray-300 border-gray-400 border-4 md:w-[45dvw] w-[85dvw] translate-[-50%] flex flex-col jusitfy-between align-middle">
            ...
            <form onSubmit={handleAuth} className="flex flex-col justify-center align-middle py-7 px-10">
                {isRegistering && (
                    <>
                ...
                <input 
                    ...
                    required
                />
                <button type="submit" className="mt-4 font-semibold relative left-[50%] translate-x-[-50%] cursor-pointer p-1 bg-gray-100 w-20 hover:bg-gray-500">
                    {isRegistering ? 'Criar Conta' : 'Entrar'}
                </button>
            </form>
            <div className="w-full flex justify-between pb-3 px-10">
                <a href="#" className="cursor-pointer hover:underline">Esqueci minha Senha</a>
                <a href="#" className="cursor-pointer hover:underline" onClick={() => setIsRegistering(!isRegistering)}>
